<template>
  <div class="form-item-daterange">
    <div class="form-item-row">
      ...
      <form-item-field :name="'开始日期'">
        <input type="text" :placeholder="'请选择'" :value="field.value.split(',')[0]" readonly>
        <input type="date" v-model="valueStart" @change="changeStart()" :readonly="field.readonly">
      </form-item-field>
    </div>
    <div class="form-item-row">
      <div class="form-item-arrow">
      ...
      <form-item-field :name="'结束日期'">
        ...
        <input type="date" v-model="valueEnd" @change="changeEnd()" :readonly="field.readonly">
      </form-item-field>
    </div>
  </div>
</template>
